...
$routes->get('/produtos/exportar', 'Produtos::exportarExcel');
...
$routes->get('/locacoes/paginacao_json/(:num)', 'Locacoes::paginacao_json/$1');
$routes->post('locacoes/alterar_situacao/(:num)', 'Locacoes::alterar_situacao/$1');
...
$routes->get('/api/disponibilidade', 'Api::verificar');