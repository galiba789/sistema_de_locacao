            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php endif;?>
                        <td>
                            <a href="<?=base_url('clientes/editar/'). $cliente['id'].'?page=' . $pager ?>">
                                <button class="btn btn-warning btn-sm">Editar</button>
                            </a>
                            <a href="<?=base_url('clientes/excluir/'). $cliente['id']?>" onclick="return confirm('Você tem certeza que deseja excluir este cliente ?')">
                ...
                let rows = data.map(cliente => {
                    ...
                    return `
                        <tr>
                            ...
                            <td>${cliente.email || ''}</td>
                            <td>${cliente.telefone_contato || cliente.telefone_comercial}</td>
                            <td>${cpfOuCnpj || ''}</td>
                            <td>
                                <div class="btn-group">
