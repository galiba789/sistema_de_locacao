            ...
            <form action="<?= base_url('clientes/update/') . $cliente['id'] ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="nascimento" id="nascimento" class="form-control"  value="<?= $cliente['nascimento'] ?>">
                    </div>
            ...
            <form action="<?= base_url('clientes/update/') . $cliente['id'] ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="nome_fantasia" id="nome_fantasia" class="form-control"  value="<?= $cliente['nome_fantasia'] ?>">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>CNPJ:</label>
