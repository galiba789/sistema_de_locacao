    ...
    <div class="container mt-4">
        ...
        <form action="<?= base_url('produtos/editar/') . $produto['id'] ?>" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <label for="preco_compra">Preço do Produto:</label>
                    <input type="text" name="preco_compra" id="preco_compra" class="form-control" value="<?= $produto['preco_compra']?>">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="data_compra">Quantidade em Estoque:</label>
                    <input type="date" name="data_compra" id="data_compra" class="form-control" value="<?= $produto['data_compra']?>">
                </div>
                <div class="col-md-12 mb-3">
