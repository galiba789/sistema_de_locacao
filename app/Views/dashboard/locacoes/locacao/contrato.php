<div style="font-family: Arial;
  ...
  font-size: 12px;">
    ...
    <div style="width: 850px; margin: 0px auto;">
        ...
        <div style="font-family: Arial; line-height: 20px;font-size: 12px;">
            ...
            <div style="font-size: 12px; display: flex; flex-direction: column; gap: 6px;">
                ...
                <div style="display: flex; justify-content: space-between; width: 100%;">
                    <span><strong>4.3</strong> Pela locação, as partes ajustam o valor e a vigência contratual:</span>
                </div>

                <div style="display: flex; justify-content: space-between; width: 100%;">
                    <span><b>Valor da Locação:</b> R$ <?= $locacao['valor_total'] ?></span>
                    <span><b>Forma de pagamento:</b>
                        <?= $locacao['condicao'] == 1 ? 'À vista' : '' ?> <?= $locacao['forma_pagamento'] ?>
                    </span>
                </div>
                ...
                <?php if ($locacao['entrega_tipo'] == 'entrega'): ?>
                    ...
                    <div style="display: flex; justify-content: space-between; width: 100%;">
                        <span><b>Data da entrega:</b> <?= date('d/m/Y H:i:s', strtotime($locacao['data_entrega'])) ?></span>
                        <span><b>Data da devolução:</b> <?= date('d/m/Y H:i:s', strtotime($locacao['data_devolucao'])) ?></span>
                    </div>

                <?php else: ?>

                    <div style="display: flex; justify-content: space-between; width: 100%;">
                        <span><b>Data de Retirada:</b> <?= date('d/m/Y H:i:s', strtotime($locacao['data_entrega'])) ?></span>
                        <span><b>Data de Entrega:</b> <?= date('d/m/Y H:i:s', strtotime($locacao['data_devolucao'])) ?></span>
                    </div>
