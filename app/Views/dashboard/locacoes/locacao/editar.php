...
<div class="content-wrapper">
    <div class=" container mt-4">
        ...
        <form action="<?= base_url('locacoes/editar/') . $locacao['id'] ?>" method="post">
            <input type="hidden" name="page" value="<?= $pager ?>">
            <div class="row">
                ...
                <?php foreach ($locacao['produtos'] as $produto): ?>
                    <div class="row align-items-end produto-item">
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" id="preco_diaria_<?= $produto['produto_id'] ?>" name="preco_diaria[]" value="<?= $produto['preco_diaria'] ?>"class="form-control preco-diaria" oninput="update_quantidade(this)" min="0" step="0.01">
                        </div>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <select name="situacao" id="situacao" class="form-control">
                        ...
                        <option value="6" <?= $locacao['situacao'] == 6 ? 'selected' : '' ?>>Em andamento</option>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
...
<div class="modal fade" id="ProdutosModal" tabindex="-1" aria-labelledby="ProdutosModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"> <!-- Aumenta o tamanho da modal -->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Barra de busca -->
                <input type="text" id="buscarProdutos" class="form-control mb-3" placeholder="Buscar Produto..." onkeyup="filtrarProdutos()">
...
<script>
    ...
    const input = document.getElementById("buscarProdutos");
    const filtro = input.value.toLowerCase();
    const linhas = document.querySelectorAll("#listaProdutos .produtos-item");
