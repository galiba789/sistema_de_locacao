...
<div class="container mt-4">
                    ...
                    <tbody>
                        <?php foreach ($locacao['produtos'] as $produto): ?>
                            <tr>
                                ...
                                <td><?= number_format($produto['preco_diaria'], 2, ',', '.') ?></td>
                                <td>R$ <?= number_format($produto['quantidade'] * $produto['preco_diaria'], 2, ',', '.') ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <div class="d-flex justify-content-between align-items-center mt-4">
            ...
            <a href="<?= base_url('locacoes/edita/' . $locacao['id']) ?>" class="btn btn-outline-primary">Editar Locação</a>
        </div>
</div>
<?= $this->endSection(); ?> 